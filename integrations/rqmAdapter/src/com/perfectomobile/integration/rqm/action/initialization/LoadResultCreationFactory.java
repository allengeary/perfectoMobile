...
public class LoadResultCreationFactory extends AbstractAdapterAction
{
	public static final String NAME = "Load Result Creation Factory";
	public static final String SP_URL = "SP URL";
	private static final String AUTO_ADAPTER = "http://open-services.net/ns/auto#AutomationResult";
